<x-layouts.saas title="SaaS Template">
    ...
    <section class="gradient-hero text-white py-16 lg:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">
                {{ __('The operating system') }}<br>{{ __('for your') }} <span class="text-blue-200">{{ __('business') }}</span>
            </h1>
            <p class="mt-6 text-lg sm:text-xl text-blue-100 max-w-2xl mx-auto">
                {{ __('All-in-one software to manage orders, production, payments, and customers. Designed for service businesses and custom order shops.') }}
            </p>
            ...
            <p class="mt-4 text-sm text-blue-200">{{ __('No credit card required') }}</p>
        </div>
    </section>
    ...
    <section id="features" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900">{{ __('Everything you need for your business') }}</h2>
                <p class="mt-4 text-lg text-gray-600">{{ __('Professional tools from day one') }}</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="p-6 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-lg transition">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Order Management') }}</h3>
                    <p class="text-gray-600 text-sm">{{ __('Step-by-step wizard: customer, items, delivery, payments, and summary. Everything organized.') }}</p>
                </div>
                ...
                <div class="p-6 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-lg transition">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Production Tracking') }}</h3>
                    <p class="text-gray-600 text-sm">{{ __('Production checklist, status tracking, and integrated shipping labels.') }}</p>
                </div>
                ...
                <div class="p-6 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-lg transition">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Quotes') }}</h3>
                    <p class="text-gray-600 text-sm">{{ __('Quick quotes with configurable pricing. PDF generation included.') }}</p>
                </div>
                ...
                <div class="p-6 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-lg transition">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Payments') }}</h3>
                    <p class="text-gray-600 text-sm">{{ __('Payment links, deposits, pending balances. Accept card, bank transfer, and more.') }}</p>
                </div>
                ...
                <div class="p-6 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-lg transition">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Customer Portal') }}</h3>
                    <p class="text-gray-600 text-sm">{{ __('Your customers check their orders, payments, and addresses from their own portal.') }}</p>
                </div>
                ...
                <div class="p-6 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-lg transition">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Dashboard') }}</h3>
                    <p class="text-gray-600 text-sm">{{ __('Real-time metrics: orders, payments, balances, and production in one place.') }}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <blockquote class="text-xl sm:text-2xl text-gray-700 italic">
                {{ __('This platform helped us organize our entire process, from quoting to delivery. We save hours every week.') }}
            </blockquote>
            <div class="mt-6">
                <p class="font-semibold text-gray-900">{{ __('Happy Customer') }}</p>
                <p class="text-sm text-gray-500">{{ __('Service Business Owner') }}</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-blue-600">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl sm:text-4xl font-bold text-white mb-4">{{ __('Start your free trial') }}</h2>
            <p class="text-lg text-blue-100 mb-8">{{ __('14 days free. No credit card required. Cancel anytime.') }}</p>
