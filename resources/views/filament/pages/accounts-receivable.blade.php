<x-filament-panels::page>
    <x-filament::section>
        <div class="flex items-center justify-between">
            <div>
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('farm.outstanding_balance') }}</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('farm.total_pending_collection') }}</p>
            </div>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-gray-200 dark:border-gray-700">
                        ...
                        <th class="px-4 py-3 text-left font-medium text-gray-500 dark:text-gray-400">{{ __('Phone') }}</th>
                        <th class="px-4 py-3 text-left font-medium text-gray-500 dark:text-gray-400">{{ __('Type') }}</th>
                        <th class="px-4 py-3 text-right font-medium text-gray-500 dark:text-gray-400">{{ __('farm.total_billed') }}</th>
                        <th class="px-4 py-3 text-right font-medium text-gray-500 dark:text-gray-400">{{ __('farm.total_paid') }}</th>
                        <th class="px-4 py-3 text-right font-medium text-gray-500 dark:text-gray-400">{{ __('Balance') }}</th>
                    </tr>
                </thead>
                ...
                @if($debtors->count() > 0)
                    <tfoot>
                        <tr class="border-t-2 border-gray-300 dark:border-gray-600">
                            <td colspan="5" class="px-4 py-3 text-right font-semibold text-gray-900 dark:text-white">{{ __('farm.total_outstanding') }}</td>
