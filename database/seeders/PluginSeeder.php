    ...
    public function run(): void
    {
        $plugins = [
            ...
            [
                'slug' => 'production',
                'name' => 'Egg Production',
                'description' => 'Track daily egg production by hen batch with quality grading.',
            ...
            [
                'slug' => 'shipments',
                'name' => 'Shipments & Deliveries',
                'description' => 'Manage delivery routes, assign drivers, and track shipment status.',
                'icon' => 'heroicon-o-truck',
                'category' => 'farm',
                'is_free' => true,
                'included_in_plans' => ['starter', 'growth', 'pro'],
                'required_modules' => ['shipments'],
                'sort_order' => 110,
            ],
            [
                'slug' => 'suppliers',
                ...
                'is_free' => true,
                'included_in_plans' => ['starter', 'growth', 'pro'],
                'required_modules' => ['suppliers'],
                'sort_order' => 120,
            ],
            [
                'slug' => 'expenses',
                'name' => 'Expense Tracking',
                'description' => 'Record and categorize farm expenses with supplier association.',
                'icon' => 'heroicon-o-banknotes',
                'category' => 'farm',
                'is_free' => true,
                'included_in_plans' => ['starter', 'growth', 'pro'],
                'required_modules' => ['expenses'],
                'sort_order' => 130,
            ],
            [
                'slug' => 'inventory',
                'name' => 'Inventory Control',
                'description' => 'Real-time egg inventory with low-stock alerts and stock calculations.',
                'icon' => 'heroicon-o-archive-box',
                'category' => 'farm',
                'is_free' => false,
                'price_monthly' => 499,
                'stripe_price_id' => 'price_inventory_monthly',
                'included_in_plans' => ['growth', 'pro'],
            ...
            [
                'slug' => 'hen_health',
                'name' => 'Hen Health Records',
                'description' => 'Track vaccinations, treatments, and health observations per batch.',
                'icon' => 'heroicon-o-heart',
                'category' => 'farm',
                'is_free' => false,
                'price_monthly' => 499,
                'stripe_price_id' => 'price_hen_health_monthly',
                'included_in_plans' => ['growth', 'pro'],
                'required_modules' => ['hen_health'],
                'sort_order' => 150,
            ],
            [
